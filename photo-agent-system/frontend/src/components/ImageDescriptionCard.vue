...
<template>
    <div class="col">
        <div :class="`card h-100 text-center ${imgDescVm.delete ? 'border border-danger' : ''}`">
            <div>
                        ...
                        <div :id="`collapseDetails-${imgDescVm.filename}`" class="accordion-collapse collapse"
                            ...
                            <div class="accordion-body">
                                ...
                                <div v-if="imgDescVm?.objects?.length">
                                    ...
                                    <div>
                                        <ul v-for="object in imgDescVm.objects" :key="object.name" class="list-group">
                                            <li class="list-group-item d-flex align-items-start">
                                                <div class="ms-2 me-auto">
                                                    <div class="fw-italic">{{ object.name }}</div>
                                                    {{ object.attributes }}
                                                </div>
                                            </li>
                                        </ul>
